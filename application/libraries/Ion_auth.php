...
class Ion_auth
{
	...
	public function is_programmer($id = false)
	{
		$this->ion_auth_model->trigger_events('is_programmer');

		$programmer_group = $this->config->item('programmer_group', 'ion_auth');

		return $this->in_group($programmer_group, $id);
	}
	...
	{
		$this->ion_auth_model->trigger_events('is_teacher');

		$teacher_group = $this->config->item('teacher_group', 'ion_auth');

		return $this->in_group($teacher_group, $id);
	}
