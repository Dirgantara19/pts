...
$config['host_dev'] = array('localhost', 'raport.test');
// Fill in the file of your project here when you develop locally.
$host_dev = 'raport.test';
// Fill in the domain name here when your project is online.
$host_prod = 'raport';

// WARNING: Do not modify the lines below
$domain = (in_array($_SERVER['HTTP_HOST'], $config['host_dev'], TRUE)) ? $host_dev : $host_prod;

$config['base_url'] = (!empty($_SERVER['HTTP'])) ? 'https://' . $domain : 'http://' . $domain;
