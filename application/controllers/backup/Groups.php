...
class Groups extends Admin
{
	...
	public function index()
	{
		...
		else
		{
			...
			$this->data['page_content']   = 'admin/groups/index';
	...
	public function add()
	{
		...
		else
		{
			...
			else
			{
				...
				$this->data['page_content'] = 'admin/groups/add';
	...
	public function edit($id)
	{
		...
		else
		{
			...
			$this->data['page_content'] = 'admin/groups/edit';
	...
	public function import()
	{
		...
		else
		{
			...
			$this->data['page_content'] = 'admin/groups/import';
