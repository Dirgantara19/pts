<script>
    ...
    $(document).ready(function() {
        ...
        let table = new DataTable('#table-example3', {
            ...
            ajax: {
                'url': '<?= base_url('admin/datatables/nilai/ajax_list'); ?>',
                'type': 'post',
                'data': function(d) {
                    getAjaxData(d);
                }
        ...
        table.on('click', '.update', function(e) {
            ...
            let nis = data.nis;
            let url = "<?= base_url('admin/datatables/nilai/get_id'); ?>";
        ...
        $("#form").on("submit", function(event) {
            ...
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: '<?= base_url('admin/datatables/nilai/save'); ?>',
                data: formdata,
